...
const CartSlide = ({ HandleSideBar }) => {
  ...
  return (
    <section className=" fixed top-0 right-0 bg-[rgba(0,0,0,0.53)] w-full h-full z-50 duration-1000 delay-1000 ">
      <div
        ref={cartRef}
        className="bg-brand h-[600px] xl:w-[30%] lg:w-[35%] md:w-[45%] sm:w-[60%] w-[95%] absolute right-0 top-4 p-8 rounded-l-3xl"
      >
        <div className="flex justify-between items-center">
          <h3 className="font-medium text-xl font-Raleway text-[#000000]">
            Shopping Cart
          </h3>
          <h3>
            <FaRegWindowClose
        ...
        {productList.length > 0 ? (
          <>
            ...
            <div className="flex justify-between pt-28">
              <p className="font-normal font-Opensans text-base text-[#000000]">
                Subtotal
              </p>
              <p className="font-normal font-Opensans text-base text-[#B88E2F]">
                Rs. {totalPrice}
              </p>
            </div>
          </>
